...
#define NPPMSG  (WM_USER + 1000)
	...
	//void WM_PIMENU_CHECK(UINT	funcs[X]._cmdID, TRUE/FALSE)

	#define NPPM_ADDTOOLBARICON_DEPRECATED (NPPMSG + 41)
	//void NPPM_ADDTOOLBARICON(UINT funcs[X]._cmdID, toolbarIcons iconHandles) -- DEPRECATED : use NPPM_ADDTOOLBARICON_FORDARKMODE instead
	...
	// VOID NPPM_ADDTOOLBARICON_FORDARKMODE(UINT funcs[X]._cmdID, toolbarIconsWithDarkMode iconHandles)
